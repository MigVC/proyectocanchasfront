...
export const PieHome = ({ seccion }) => {
  return (
    <div
      className='banner text-center colorprim p-1'
    ...
    >
      <div className='mx-3 animate__animated animate__fadeIn'>
        <Grid container p={4}>
          <Grid item xs={12}>
            ...
            >
              Trabajamos para brindarte la mejor experiencia y encontrar la
              canchita perfecta para ti
            </Typography>
          </Grid>
          <Grid item xs={2}></Grid>
        </Grid>
      ...
      {seccion && (
        <>
          <Typography
            sx={{ fontFamily: style.typography, color: 'white', fontSize: 21 }}
          >
