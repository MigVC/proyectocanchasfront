...
const registroCanchitaSchema= yup.object({
    nombreCanchita:yup
    .string()
    .required('Ingrese nombre de la Canchita'),
    descripcion:yup
    .string()
    .required('Ingrese descripción de la Canchita'),
    ubicacion:yup
    .string()
    .required('Ingrese ubicación de la Canchita'),
    cantApacamiento:yup
    .number()
    .typeError('Cantidad')
    ...
    .required(),
    files:yup
    .mixed().test('Requerido, porfavor selecione una imagen',value=>{
            ...
            <Grid container spacing={1} p={2}>
                <Grid item xs={12}>
                    <TextField
                        ...
                        InputProps={{
                            endAdornment: <InputAdornment position="end"><Arco/></InputAdornment>,
                          }}
                          
                        error={!!errors.nombreCanchita}
                        helperText={!!errors.nombreCanchita? errors.nombreCanchita.message:null}
                    />
                </Grid>
                <Grid item xs={6}>
                    <TextField
                ...
                <Grid item xs={12} mb={1}>
                    <TextField
                        ...
                        {...register('precio')}
                        InputProps={{
                            endAdornment: <InputAdornment position='end'><SavingsIcon/></InputAdornment>,
                          }}
                ...
                <Grid item xs={12}>
                    <TextField
                        ...
                        InputProps={{
                            endAdornment: <InputAdornment position='end'><GroupsIcon/></InputAdornment>,
                          }}
                          
                        error={!!errors.cantApacamiento}
                        helperText={!!errors.cantApacamiento? errors.cantApacamiento.message:null}
                    />
                </Grid>
                </Grid>
                <Grid item xs={12} >
